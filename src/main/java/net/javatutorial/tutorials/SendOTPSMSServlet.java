...
//		request.setAttribute("visitPurpose", visitPurposes);
	...
	public static void sendOTP(String mobileNo, String otp) {
		try {
			...
			String command = "curl -X POST -d to=+"+mobileNo+"&message=Blower.io -H Accept: application/json https://d5f0629a-0abd-400f-9059-7a996b7da98a:QKnJYGZLd7Rrx2UQyzrqvg@api.blower.io/messages";
