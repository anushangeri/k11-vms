 ...
 */
public class UpdateVehicleCustomTimeOutRecordServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String timeOutDt = request.getParameter("timeout");
		Timestamp timeOutAstTimestamp = Timestamp.valueOf(timeOutDt);
		Vehicle v = null;
		...
		if(vehicleId != null && !StringUtils.isEmpty(vehicleId)) {
			...
			v.setTimeOutDt(timeOutAstTimestamp);
			...
			message = VehMSManagerDAO.updateVehicleCustomTimeOut(v);
