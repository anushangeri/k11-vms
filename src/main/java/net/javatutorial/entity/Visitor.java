...
public class Visitor {
	...
	public Visitor(String vmsId, String name, String companyName, String site, String idType, String idNo,
			...
			String covidDeclare, String visitPurpose, String temperature, Timestamp timeInDt, Timestamp timeOutDt) {
		super();
		this.vmsId = vmsId;
		this.name = name;
	...
	public String toString() {
		return "Visitor [vmsId=" + vmsId + ", name=" + name + ", companyName=" + companyName + ", site=" + site
				...
				+ ", covidDeclare=" + covidDeclare + ", visitPurpose=" + visitPurpose + ", temperature=" + temperature
